...
namespace GymAssignment.Data.Migrations
{
    ...
    [Migration("20191204153906_Implement Roles")]
    partial class ImplementRoles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymAssignment.Models.GymUser", b =>
                {
            ...
            modelBuilder.Entity("GymAssignment.Models.StoreRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GymAssignment.Models.TimeOffSchedule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Tyler Lindley",
                            PostTime = new DateTime(2019, 12, 4, 10, 39, 6, 400, DateTimeKind.Local).AddTicks(3910)
                        },
                        new
                        {
                            Id = 25,
                            ...
                            Date = "January 1st to February 4th",
                            Name = "Kyle Scagnetti",
                            PostTime = new DateTime(2019, 12, 4, 10, 39, 6, 404, DateTimeKind.Local).AddTicks(411)
                        },
                        new
                        {
                            Id = 26,
                            ...
                            Name = "Justin Hunt",
                            PostTime = new DateTime(2019, 12, 4, 10, 39, 6, 404, DateTimeKind.Local).AddTicks(450)
                        },
                        new
                        {
                            Id = 27,
                            ...
                            Date = "Februay 24th to February 29th",
                            Name = "Mason Ferrie",
                            PostTime = new DateTime(2019, 12, 4, 10, 39, 6, 404, DateTimeKind.Local).AddTicks(458)
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("GymAssignment.Models.StoreRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GymAssignment.Models.GymUser", null)
                        .WithMany()
